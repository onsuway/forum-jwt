...
<template>
    <div class="main-content" v-loading="loading" element-loading-background="正在进入，请稍候...">
            ...
            <el-header class="main-content-header">
                ...
                <div class="user-info">
                    <el-popover placement="bottom" :width="350" trigger="click">
                        ...
                        <div style="margin-top: 10px; text-align: center" v-if="notification.length">
                            <el-button size="small" type="info" :icon="Check" @click="deleteAllNotification"
                                       style="width: 60%;" plain>
                                全部已读
                            </el-button>
                        </div>
                    </el-popover>
