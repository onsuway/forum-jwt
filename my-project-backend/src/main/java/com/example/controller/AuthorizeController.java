...
public class AuthorizeController {
    ...
    public RestBean<Void> register(@RequestBody @Valid RegisterByEmailVO vo){
        return utils.messageHandle(() ->
    ...
    public RestBean<Void> resetConfirm(@RequestBody @Valid EmailConfirmVO vo){
    ...
    public RestBean<Void> resetPassword(@RequestBody @Valid ResetPasswordByEmailVO vo){
        return utils.messageHandle(() ->
